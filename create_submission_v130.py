...
def identify_quiet_segments(vibration_data, percentile=15):  # LOOSER
    window_size = 1000
...
def calculate_baseline_ultrasonic(vibration_data):
    quiet_indices = identify_quiet_segments(vibration_data, percentile=15)
...
print("v130: Baseline Ultrasonic (15% Quietest Segments)")
...
print(f"v130 saved to {output_file}")